...
BSCFilter: TypeAlias = Annotated[
    bool,
    typer.Option(help="Whether to print BSC events or not."),
]
ClassFilter: TypeAlias = Annotated[
    list[int],
    typer.Option(
        "--class-filters",
        "-cf",
...
SubclassFilter: TypeAlias = Annotated[
    list[int],
    typer.Option(
        "--subclass-filters",
        "-sf",
...
ThreadID: TypeAlias = Annotated[
    int | None,
    typer.Option(help="Thread ID to filter. Omit for all."),
]
ShowThreadID: TypeAlias = Annotated[
    bool,
    typer.Option(help="Whether to print thread ID or not."),
]


def parse_filters(subclasses: list[int], classes: list[int]) -> set[int] | None:
