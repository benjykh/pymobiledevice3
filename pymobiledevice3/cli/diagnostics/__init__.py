...
def diagnostics_ioregistry(
    service_provider: ServiceProviderDep,
    plane: Annotated[str | None, typer.Option()] = None,
    name: Annotated[str | None, typer.Option()] = None,
    ioclass: Annotated[str | None, typer.Option()] = None,
) -> None:
    """Get ioregistry info"""
...
@cli.command("mg")
def diagnostics_mg(service_provider: ServiceProviderDep, keys: list[str] | None = None) -> None:
