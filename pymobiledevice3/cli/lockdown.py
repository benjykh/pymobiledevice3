...
@cli.command("get")
def lockdown_get(service_provider: ServiceProviderDep, domain: str | None = None, key: str | None = None) -> None:
...
@cli.command("unpair")
def lockdown_unpair(service_provider: NoAutoPairServiceProviderDep, host_id: str | None = None) -> None:
...
def lockdown_language(service_provider: ServiceProviderDep, language: str | None = None) -> None:
...
@cli.command("locale")
def lockdown_locale(service_provider: ServiceProviderDep, locale: str | None = None) -> None:
    """Get/Set current language settings"""
...
def lockdown_device_name(service_provider: ServiceProviderDep, new_name: str | None = None) -> None:
...
def lockdown_wifi_connections(service_provider: ServiceProviderDep, state: Literal["on", "off"] | None = None) -> None:
...
def lockdown_assistive_touch(service_provider: ServiceProviderDep, state: Literal["on", "off"] | None = None) -> None:
